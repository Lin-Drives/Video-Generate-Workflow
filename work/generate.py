...
('从像素到语义','神经网络把像素变成物体，这是门，那是台阶，前面有人。机器人要知道的不只是环境里有什么。还要判断能不能安全通行。要抓取的对象处在什么状态，能不能抓取。','这台硅片搬运机器人在一台工艺机台的上下料口前停下，顶部深灰色机械臂的夹爪悬停在对接位置前方，表现它正在分辨这是哪台机台和能不能对接的判断瞬间。'),
