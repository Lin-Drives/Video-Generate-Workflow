...
('系统工程结论','所以看见不是一台相机的事。是传感器、算法、算力和安全策略的系统工程。感知越可靠，机器人的动作执行成功率才会越高，同样也越安全。','抽象化的硅片搬运机器人背影，静立于洁净室中央，机械臂自然收拢，周身被稀疏的橙色点云与微光环绕，点云沿着成排机台向远处延伸融入深蓝背景，表现看见是系统工程的结论，高级工程纪录片质感。'),
]
