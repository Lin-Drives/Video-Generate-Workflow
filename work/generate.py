...
('双目与深度相机','两个摄像头像人的双眼，靠两张照片的视差估算深度。深度相机则主动发光，有的投出一片光点，看图案怎么变形。有的计算光往返一趟的时间，都能把距离直接量出来。','这台硅片搬运机器人正对右侧开放式晶圆承载舱，深度相机透出克制的浅色光锥，光锥自然落在承载舱的导轨与边缘上，像物理光影而非图形标注。'),
...
english_subtitles=[
    ...
    'Depth cameras emit their own light: some project a dot pattern and watch how it deforms',
    'Others time how long light takes to make a round trip; both measure distance directly',
